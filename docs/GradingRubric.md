...
|  User Interface HTML/CSS                | We designed an attractive interface and we used Bootstrap to implement our designs.                                    |
|  JavaScript server                      |                                                 | 
|  NodeJS backend                         |                                                 |
|  CRUD operations                        |                                                 |  
...
| General requirements                    | Our application is user friendly- it is simple, yet effective. 
